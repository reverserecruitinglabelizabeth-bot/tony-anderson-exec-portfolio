...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Executive portfolio of Tony Anderson — international Regional Quality Manager and QA/QC Executive with 20+ years leading quality assurance, compliance and operational excellence across energy, EPC, oil & gas, petrochemical, offshore and power generation programs." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Tony Anderson — Regional Quality Manager & QA/QC Executive" },
      { name: "twitter:description", content: "Executive portfolio of Tony Anderson — international Regional Quality Manager and QA/QC Executive with 20+ years leading quality assurance, compliance and operational excellence across energy, EPC, oil & gas, petrochemical, offshore and power generation programs." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/72b00b54-4dc9-40a1-8499-fcf2c37926db" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/72b00b54-4dc9-40a1-8499-fcf2c37926db" },
    ],
    links: [
